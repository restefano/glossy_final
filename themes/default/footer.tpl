...
<div title="rodape" class="grid_9 alpha omega clearfix" style="background-color:#FFF;">
	...
	<div style="width: 980px; background-color:#FFF; padding-top:20px; border-top:solid #FF00A0 8px;"><span style="font-size: 12px;">&nbsp;&nbsp;</span></div>
	</div>

	<table cellspacing="0" cellpadding="0" border="0" style="width:960px; margin: 0 auto; background-color=#FFF;">
    	<tbody>
        <tr>
            <td style="width: 960px; padding-left: 0px; text-align: center;"><a href="http://www.glossyme.com.br/contato"><img src="ric/rodape.png" width="850" height="165" alt="" /></a></td>
        </tr>
    	</tbody>
	</table>
